...
class Discriminator(nn.Module):
    def __init__(self, params):
        ...
        self.conv1 = nn.Conv2d(in_channels = params['nc'], out_channels = params['ndf'],
        ...
        self.feed_forward = nn.Linear(1764, 1)
        self.params = params
    def forward(self, x):
        print('Yo')
        ...
        x = self.conv5(x)
        x = x.view(self.params['bsize'], -1)
        print(f'Hi {x.size()}')
        x = F.sigmoid(self.feed_forward(x))
